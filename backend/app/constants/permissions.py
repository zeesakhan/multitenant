...
ROLE_PERMISSIONS = {
    ...
    "agent": [
        ...
        PAYMENT_CREATE, PAYMENT_READ, PAYMENT_READ_ALL, INVOICE_READ,
        CLAIM_CREATE, CLAIM_READ, CLAIM_READ_ALL, CLAIM_UPDATE,
    ...
    "underwriter": [
        APPLICATION_READ, APPLICATION_READ_ALL, APPLICATION_APPROVE, APPLICATION_REJECT,
        POLICY_READ, POLICY_READ_ALL, POLICY_ISSUE,
        DOCUMENT_READ, DOCUMENT_DOWNLOAD,
        MEMBER_READ,
        CLAIM_READ, CLAIM_READ_ALL, CLAIM_UPDATE, CLAIM_APPROVE, CLAIM_REJECT,
        AUDIT_LOG_READ,
        LOADING_APPLY, LOADING_READ,
        REPORT_READ,
        DASHBOARD_READ,
    ...
    "compliance_officer": [
        APPLICATION_READ, APPLICATION_READ_ALL,
        POLICY_READ, POLICY_READ_ALL,
        MEMBER_READ,
        DOCUMENT_READ, DOCUMENT_DOWNLOAD,
        AUDIT_LOG_READ, AUDIT_LOG_EXPORT,
        AML_READ, AML_CLEAR, AML_OVERRIDE,
