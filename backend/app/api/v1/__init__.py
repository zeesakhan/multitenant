...
from app.api.v1 import (
    auth, tenants, users, branding, products, quotations, applications,
    policies, members, payments, claims, workflows, documents, dashboard,
    reports, customer, buy, uae_buy, aml, govt_checks, notifications,
)
...
v1_router.include_router(uae_buy.router)
v1_router.include_router(aml.router)
v1_router.include_router(govt_checks.router)
